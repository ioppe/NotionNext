...
;(function (LIVE2DCUBISMPIXI) {
  const Model = (function (_super) {
    ...
    function Model(
      ...
      for (let m = 0; m < _this._meshes.length; ++m) {
        const uvs = _this._coreModel.drawables.vertexUvs[m].slice(
          0,
        ...
        _this._meshes[m] = new CubismMesh(
    ...
    Model.prototype.update = function (delta) {
      ...
      if (sort) {
        this.children.sort(function (a, b) {
          const aIndex = _this._meshes.indexOf(a)
          const bIndex = _this._meshes.indexOf(b)
          const aRenderOrder = _this._coreModel.drawables.renderOrders[aIndex]
          const bRenderOrder = _this._coreModel.drawables.renderOrders[bIndex]
    ...
    Model.prototype.getModelMeshById = function (id) {
      ...
      for (let _i = 0, _a = this._meshes; _i < _a.length; _i++) {
        const mesh = _a[_i]
    ...
    Model.prototype.addParameterValueById = function (id, value) {
      ...
      this._coreModel.parameters.values[p] =
        this._coreModel.parameters.values[p] + value
    }
    Model._create = function (
      coreModel,
      textures,
      animator,
      physicsRig,
  ...
  const ModelBuilder = (function () {
    ...
    ModelBuilder.prototype.buildFromModel3Json = function (
      loader,
      model3Obj,
      callbackFunc
    ) {
      ...
      if (typeof model3Obj.data['FileReferences']['Textures'] !== 'undefined') {
        model3Obj.data['FileReferences']['Textures'].forEach(
          function (element) {
      ...
      if (typeof model3Obj.data['FileReferences']['Physics'] !== 'undefined')
        loader.add(
          'physics',
          modelDir + model3Obj.data['FileReferences']['Physics'],
          { xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.JSON }
        )
      if (typeof model3Obj.data['FileReferences']['UserData'] !== 'undefined')
        loader.add(
          'userdata',
          modelDir + model3Obj.data['FileReferences']['UserData'],
          { xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.JSON }
        )
      if (typeof (model3Obj.data['Groups'] !== 'undefined'))
        this._groups = LIVE2DCUBISMFRAMEWORK.Groups.fromModel3Json(
          model3Obj.data
        )
      loader.load(function (loader, resources) {
        if (typeof resources['moc'] !== 'undefined')
          _this.setMoc(
            Live2DCubismCore.Moc.fromArrayBuffer(resources['moc'].data)
          )
