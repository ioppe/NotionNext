...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'skydrow', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'learn more', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ariya.top', // 网站地址
  ...
  WIDGET_PET_LINK:
    ...
    'https://imuncle.github.io/live2d/live2d_3/model/Azue%20Lane(JP)/beierfasite_2/beierfasite_2.model3.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
